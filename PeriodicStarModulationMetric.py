...
""" This metric is based on the sims_maf_contrib PeriodicStar metric 
    (https://github.com/LSST-nonproject/sims_maf_contrib/blob/master/mafContrib/periodicStarMetric.py).
